...
class EvalutionViewMobile extends StatelessWidget {
  const EvalutionViewMobile({super.key});
                ...
                child: TRoundedContainer(
                  ...
                  child: Column(
                    children: [
                      ...
                      EvalutionPieChart(result: controller.result,getColor: getColorForEvalution,height: screenWidth(5),radius: 80,),
                    ],
                  )),
              ),
                ...
                child: TRoundedContainer(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: TSize.spaceBtwItems,),
                      EvalutionPieChart(result: controller.result2,getColor: getColorForEvalution,height: screenWidth(5),radius: 80,),
                    ],
                  )),
              ),
