            ...
            children: [
              ...
              TRoundedContainer(
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset('assets/images/pngs/report_icons.png',
                        width: 105, height: 80),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text("عدد الطلبات \n المقبولة",
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text(controller.allProjectApprovidNum.value.toString(),
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                  ],
                ),
              ...
              TRoundedContainer(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset('assets/images/pngs/accept_order.png',
                        width: 105, height: 80),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text("عدد الطلبات \n الكلية",
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text(controller.allProjectNum.value.toString(),
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                  ],
                ),
              ...
              TRoundedContainer(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset('assets/images/pngs/reject_order.png',
                        width: 105, height: 80),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text("عدد الطلبات \n المرفوضة",
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                    SizedBox(height: TSize.spaceBtwItems),
                    Text(controller.allProjectRejectedNum.value.toString(),
                        style: TextStyle(
                            color: AppColors.primary, fontSize: screenWidth(28))),
                  ],
                ),
