...
class _UsersDesktopScreenState extends State<UsersDesktopScreen> {
  ...
  Widget build(BuildContext context) {
    final UsersViewController controller = Get.put(UsersViewController());
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () => controller
                            .exportToExcelWeb(controller.beneficiaries),
                        icon: Icon(
                          Icons.download,
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () =>
                            controller.exportToPdfWeb(controller.beneficiaries),
                        icon: Icon(
                ...
                return SizedBox(
                  ...
                  child: Theme(
                    ...
                    child: PaginatedDataTable2(
                      key: ValueKey(controller.beneficiaries.length),
