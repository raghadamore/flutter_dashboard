...
class VerifyCodeMobile extends StatefulWidget {
  const VerifyCodeMobile({super.key});

  @override
  State<VerifyCodeMobile> createState() => _VerifyCodeMobileState();
}

class _VerifyCodeMobileState extends State<VerifyCodeMobile> {
