...
class ActivityViewDesktop extends StatefulWidget {
  const ActivityViewDesktop({super.key});

  @override
  State<ActivityViewDesktop> createState() => _ActivityViewDesktopState();
}

class _ActivityViewDesktopState extends State<ActivityViewDesktop> {
  @override
