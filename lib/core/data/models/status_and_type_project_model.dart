class StatusAndTypeProjectModel {
  int? id;
  ...
  StatusAndTypeProjectModel.fromJson(Map<String, dynamic> json) {
    print(json);
    id = json['id'];
    ...
    print("Reviewer value: ${json['reviewer']} (${json['reviewer'].runtimeType})");
