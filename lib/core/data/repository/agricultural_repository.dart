...
class AgriculturalRepository {
  Future<Either<String, MedicalPeriodModel>> getAgriculltureProjectPeriod({
  required String period,
}) async {
  try {
    final value = await NetworkUtil.sendRequest(
      type: RequestType.GET,
      route: 'dashboard/stats/projects/agricultural/',
...
Future<Either<String, List<ProjectModel>>> getAllAgricultureProject({required String status}) async {
    try {
      final value = await NetworkUtil.sendRequest(
        type: RequestType.GET,
        route: 'dashboard/projects/',
        params:{"status":status,"project_type":"agricultural"},
        headers:
